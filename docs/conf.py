...
_sys_path_add(['dist', 'not_on_git', 'src', 'src/topfarm', 'src/topfarm/test', 'src/topfarm/test/data', 'src/topfarm/test/fig'])
...
project = u'topfarm'
copyright = u'(C) DTU-Wind Energy, TOPFARM Development Team'
