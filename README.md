...
## Docker installation
If you don't want to go through the painful installation process of openmdao I recommand to use the [docker installation process](http://hub.docker.com/u/piredtu/topfarm/) (hint, if you are a newbee in python and use windows you will prefer this).
